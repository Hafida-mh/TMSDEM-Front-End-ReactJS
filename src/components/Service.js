            ...
            <div className="titleContainer"> <h1> Déménagez en toute tranquilité  </h1></div>
            {
                <div className="pictureTmsDem">
                   ...
                   <div className="textSlide">  
                       <h1> Vos affaires chez vous en toute sécurité 
                           <section> sans aucun risque de casse ou d'oubli</section> 
                       </h1>
                    </div>
                </div>
            }
                ...
                <div className="serviceDetailsTitle">
                 ...
                 <div className="servceDetailsServices">
                    <div className="serviceItem">
                        <h3> Offre Soto</h3>
                        <div className="paraserviceItem"> 
                            <p> Vous voulez déménager
                                sans vous  préoccuper
                                du process ? 
                            </p>
                        </div>
                        <div className="buttoncontainer  soto"> <button> laissez-nous faire</button></div>
                  </div>
                  <div className="serviceItem">
                     <h3> Offre Chrono </h3>
                      <div className="paraserviceItem"> 
